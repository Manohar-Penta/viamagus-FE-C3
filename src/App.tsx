      ...
      <div className="p-2">
          ...
          {productList.map((product) => {
            return (
              ...
              >
                ...
                <div className="flex gap-2 border p-2 rounded-xl items-baseline">
                  <button
                  ...
                  <input
                    type="number"
                    className="font-semibold text-lg lg:text-2xl text-center outline-none w-10"
        ...
        <div className="max-w-[720px] mx-auto p-2 flex gap-2 lg:gap-4">
          <input
            ...
            className="w-full border p-2 border-collapse rounded text-xl lg:text-2xl font-semibold"
            ref={disip}
          />
          <button
